...
// Type: LSILib.FB.SlowValve.ValveDown
...
namespace LSILib.FB.SlowValve
{
  [ComVisible(true)]
  [DisplayName("Вниз")]
  [Guid("75C1DD95-D04A-4fb6-99C1-D2317B9BF642")]
  public class ValveDown : ControlBase
  {
    ...
    public ValveDown() => this.InitializeComponent();
    ...
    public override Image getPic(ControlBase.v_state s)
    {
      switch (s)
      {
        case ControlBase.v_state.v_closed:
          return (Image) Resources.valve2_bottom_closed;
        case ControlBase.v_state.v_openned_full:
          return (Image) Resources.valve2_bottom_oppened_full;
        case ControlBase.v_state.v_opened_slow:
          return (Image) Resources.valve2_bottom_closed_full;
        case ControlBase.v_state.v_openning:
        case ControlBase.v_state.v_closing:
          return (Image) Resources.valve2_bottom_changing_full;
        default:
          return (Image) Resources.valve2_bottom_unreable;
      }
    }
  }
}
