...
// Type: LSILib.FB.Device.ControlBase
...
namespace LSILib.FB.Device
{
  public class ControlBase : VisualControlBase
  {
      ...
      : base(true)
    {
      ...
      this.opening = false;
      this.closing = false;
      this.pictureBox1.Image = this.getPic(ControlBase.v_state.v_openned);
    }

    public virtual Image getPic(ControlBase.v_state s) => (Image) Resources.pump_right_unreable;

    public virtual Image getPicForForm(ControlBase.v_state s)
    {
      return (Image) Resources.pump_right_unreable;
    }

    public virtual string getOpenStartText() => "Открыть";

    public virtual string getCloseStopText() => "Закрыть";
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
      ...
      if (this.iOldState != num || pinQuality != this.old_q)
      {
        ...
        if ((num & 8) != 0)
          ...
          this.pictureBox1.Image = (num & 1) == 0 || (num & 262144) != 0 ? this.getPic(ControlBase.v_state.v_wtf) : this.getPic(ControlBase.v_state.v_midle);
      }
    ...
    private void InitializeComponent()
    {
      ...
      this.SuspendLayout();
      this.pictureBox1.Image = (Image) Resources.pump_right_started;
