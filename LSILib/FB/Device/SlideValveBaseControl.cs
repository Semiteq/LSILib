...
// Type: LSILib.FB.Device.SlideValveBaseControl
...
{
  public class SlideValveBaseControl : ValveSlideValveBaseControl
  {
    ...
    public SlideValveBaseControl() => this.InitializeComponent();
